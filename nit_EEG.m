function varargout = nit_EEG(varargin)
% -------------------------------------------------------------------------
...
%            2016/10/12
%--------------------------------------------------------------------------
% NIT_EEG MATLAB code for nit_EEG.fig
%      NIT_EEG, by itself, creates a new NIT_EEG or raises the existing
%      singleton*.
%
%      H = NIT_EEG returns the handle to a new NIT_EEG or the handle to
%      the existing singleton*.
%
%      NIT_EEG('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in NIT_EEG.M with the given input arguments.
%
%      NIT_EEG('Property','Value',...) creates a new NIT_EEG or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before nit_EEG_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to nit_EEG_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help nit_EEG

% Last Modified by GUIDE v2.5 05-Jun-2018 15:17:15

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @nit_EEG_OpeningFcn, ...
                   'gui_OutputFcn',  @nit_EEG_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before nit_EEG is made visible.
function nit_EEG_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to nit_EEG (see VARARGIN)

% Choose default command line output for nit_EEG
...
% UIWAIT makes nit_EEG wait for user response (see UIRESUME)
% uiwait(handles.nit_EEG);


% --- Outputs from this function are returned to the command line.
function varargout = nit_EEG_OutputFcn(hObject, eventdata, handles) 
